/* =====================================================================
   terrain.ts. File 2 of 7.

   One job: the kinds of ground. It is project 18's table, copied here
   line for line. Nothing about it changed.

   The search reads `walkable`. A route can cross any ground the table
   calls walkable, and never water or rock.

   The tanks read `speed`, the same as project 19. The search does not.
   To the search, one cell is one step, whatever grows on it.
   ===================================================================== */
