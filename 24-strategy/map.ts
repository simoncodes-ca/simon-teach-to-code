/* =====================================================================
   ...
   One job: the map. It is project 20's map.ts, copied line for line.
   Nothing about it changed.

   The ore is not in here. The ground says where ore grows, and that is
   all a map knows. How much ore is left in each cell is a second grid
   of numbers, and it lives in ore.ts.

   Like project 20's map.ts, this file never draws anything. The page
