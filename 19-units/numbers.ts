/* =====================================================================
   ...
   Unit Selection. Six tanks wait on a map from the map editor. You
   click one to pick it, or drag a box round several. Then you click
   the ground, and they drive there.

   This file only remembers. It holds the sizes the page is built
   from, and the numbers the tanks drive by.
   ===================================================================== */
